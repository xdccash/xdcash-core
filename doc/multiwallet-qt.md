...
In order to support loading of multiple wallets in xdcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xdcash.cpp.
...
Changes to xdcash.cpp
----------------------
xdcash.cpp is the entry point into xdcash-qt, and as such, will require some minor modifications to provide hooks for
