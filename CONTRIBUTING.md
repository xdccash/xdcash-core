Contributing to XdCash Core
============================

The XdCash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the XdCash Core project, and is not to be
confused with overall XdCash Network Protocol consensus changes.

Whether a pull request is merged into XdCash Core rests with the project merge
...
Patches that change XdCash consensus rules are considerably more involved than
...
Where a patch set proposes to change the XdCash consensus, it must have been
...
The project leader is the release manager for each XdCash Core release.
