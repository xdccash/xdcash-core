...
public:
    ...
    void setZXdCashControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzXDCASH_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzXDCASH_clicked();
    void on_pushButtonZXdCashControl_clicked();
