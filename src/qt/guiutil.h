...
/** Utility functions used by the Xdcash Qt UI.
 */
namespace GUIUtil
{
...
// Render Xdcash addresses in monospace font
...
// Parse "xdcash:" URI into recipient object, return true on successful parsing
