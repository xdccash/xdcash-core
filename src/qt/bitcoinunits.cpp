...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(XDCASH);
    unitlist.append(mXDCASH);
    unitlist.append(uXDCASH);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case XDCASH:
        return QString("xdcash");
    case mXDCASH:
        return QString("mxdcash");
    case uXDCASH:
        return QString::fromUtf8("uxdcash");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case mXDCASH:
            return QString("mXDCASH");
        case uXDCASH:
            return QString::fromUtf8("μXDCASH");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case XDCASH:
            return QString("tXDCASH");
        case mXDCASH:
            return QString("mtXDCASH");
        case uXDCASH:
            return QString::fromUtf8("μtXDCASH");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case XDCASH:
            return QString("XDCASH");
        case mXDCASH:
            return QString("Milli-XDCASH (1 / 1" THIN_SP_UTF8 "000)");
        case uXDCASH:
            return QString("Micro-XDCASH (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case XDCASH:
            return QString("TestXDCASHs");
        case mXDCASH:
            return QString("Milli-TestXDCASH (1 / 1" THIN_SP_UTF8 "000)");
        case uXDCASH:
            return QString("Micro-TestXDCASH (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
