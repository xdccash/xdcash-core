...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("XdCash Core xdcash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xdcash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xdcash transaction") + "\n" +
                               "  xdcash-tx [options] -create [commands]   " + _("Create hex-encoded xdcash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xdcash transaction
