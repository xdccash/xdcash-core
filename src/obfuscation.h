...
{
public:
    /// Is the inputs associated with this public key? (and there is 25000 XDCASH - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of xdcash.
