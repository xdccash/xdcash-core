...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XdCash features */
        {"xdcash", "masternode", &masternode, true, true, false},
        {"xdcash", "listmasternodes", &listmasternodes, true, true, false},
        {"xdcash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"xdcash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"xdcash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"xdcash", "masternodedebug", &masternodedebug, true, true, false},
        {"xdcash", "startmasternode", &startmasternode, true, true, false},
        {"xdcash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"xdcash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"xdcash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"xdcash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"xdcash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"xdcash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"xdcash", "mnbudget", &mnbudget, true, true, false},
        {"xdcash", "preparebudget", &preparebudget, true, true, false},
        {"xdcash", "submitbudget", &submitbudget, true, true, false},
        {"xdcash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"xdcash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"xdcash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"xdcash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"xdcash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"xdcash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"xdcash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xdcash", "checkbudgets", &checkbudgets, true, true, false},
        {"xdcash", "mnsync", &mnsync, true, true, false},
        {"xdcash", "spork", &spork, true, true, false},
        {"xdcash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"xdcash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use xdcashd, or the -server option to xdcash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> xdcash-cli " + methodname + " " + args + "\n";
}
