...
RESOURCES += src/qt/xdcash.qrc src/qt/xdcash_locale.qrc

TRANSLATIONS += src/qt/locale/xdcash_bg.ts \
                src/qt/locale/xdcash_de.ts \
                src/qt/locale/xdcash_en.ts \
                src/qt/locale/xdcash_es.ts \
                src/qt/locale/xdcash_fi.ts \
                src/qt/locale/xdcash_fr.ts \
                src/qt/locale/xdcash_it.ts \
                src/qt/locale/xdcash_ja.ts \
                src/qt/locale/xdcash_pl.ts \
                src/qt/locale/xdcash_pt.ts \
                src/qt/locale/xdcash_ru.ts \
                src/qt/locale/xdcash_sk.ts \
                src/qt/locale/xdcash_sv.ts \
                src/qt/locale/xdcash_vi.ts \
                src/qt/locale/xdcash_zh_CN.ts \
                src/qt/locale/xdcash_zh_TW.ts
